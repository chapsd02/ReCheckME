...
1.  **ดึงข้อมูลหลัก:** ค้นหาและระบุข้อมูลแต่ละส่วนอย่างเป็นระบบ: ขนาด -> ประเภท -> สภาพภายนอก
...
3.  **reading:** หน่วยการใช้ไฟฟ้า (kWh) ที่อ่านได้
4.  **meterCondition:** สภาพภายนอกโดยรวม (เช่น 'ปกติ', 'ชำรุด', 'กระจกฝ้า/มัว', 'มีรอยแตก', 'มีคราบสกปรก', 'เสียหายจากน้ำ')
  ...
  const response = await ai.models.generateContent({
    ...
    config: {
      ...
      responseSchema: {
        ...
        required: ["meterSize", "meterType", "reading", "meterCondition"],
      },
    },
  });
