...
1.  **ดึงข้อมูลหลัก:** ค้นหาและระบุข้อมูลแต่ละส่วนอย่างเป็นระบบ: หมายเลข PEA -> ขนาด -> ประเภท -> สภาพภายนอก
2.  **อ่านค่าหน่วย (สำคัญที่สุด):** ให้ความสำคัญสูงสุดกับการอ่านค่าหน่วยการใช้ไฟฟ้า (reading) เป็นลำดับสุดท้าย เพื่อให้แน่ใจว่าได้โฟกัสอย่างเต็มที่
...
**ข้อมูลที่ต้องการ:**
1.  **peaNumber:** หมายเลข PEA หรือหมายเลขเครื่องวัดไฟฟ้าที่ปรากฏบนมิเตอร์
2.  **meterSize:** ขนาดของมิเตอร์ (เช่น 5(15)A, 15(45)A, 30(100)A)
3.  **meterType:** ประเภทของมิเตอร์ ('จานหมุน' หรือ 'ดิจิทัล')
4.  **reading:** หน่วยการใช้ไฟฟ้า (kWh) ที่อ่านได้
5.  **meterCondition:** สภาพภายนอกโดยรวม (เช่น 'ปกติ', 'ชำรุด', 'กระจกฝ้า/มัว', 'มีรอยแตก', 'มีคราบสกปรก', 'เสียหายจากน้ำ')
